...
---@class kago.pairs.Config
---@field pairs table<string, string>
---@field quotes string[]

---@class kago.pairs.Mappings
---@field pairs table<string, string>?
---@field quotes string[]?
---@field backspace string[]?
---@field cr string?

---@class kago.pairs.Setup
---@field mappings kago.pairs.Mappings?

---@type kago.pairs.Config
M.config = {
  pairs = {},
  quotes = {},
}
