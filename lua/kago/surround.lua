...
---@class kago.surround.Mappings
---@field add string?
---@field delete string?
---@field replace string?

---@class kago.surround.Setup
---@field mappings kago.surround.Mappings?
...
---@class kago.surround.BracketPair
---@field open string
---@field close string
...
---@type table<string, kago.surround.BracketPair?>
local bracket_pairs = {
...
---@param opts kago.surround.Setup?
function M.setup(opts)
  ...
  if mappings.add and mappings.add ~= '' then
    vim.keymap.set('n', mappings.add, function()
      cache.add_char = nil
      vim.o.operatorfunc = 'v:lua._kago_surround.add_op'
      return 'g@'
  ...
  if mappings.delete and mappings.delete ~= '' then
    vim.keymap.set('n', mappings.delete, function()
      ...
      vim.o.operatorfunc = 'v:lua._kago_surround.delete_op'
      return 'g@ '
    end, { expr = true, noremap = true })
  end
  ...
  if mappings.replace and mappings.replace ~= '' then
    vim.keymap.set('n', mappings.replace, function()
      ...
      vim.o.operatorfunc = 'v:lua._kago_surround.replace_op'
      return 'g@ '
    end, { expr = true, noremap = true })
  end
end
