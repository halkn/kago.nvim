local M = {}
local input_ns = vim.api.nvim_create_namespace('kago_explorer_filter_input')

---@class kago.explorer.Filter
---@field query string
---@field root string
---@field hidden boolean
---@field candidates kago.explorer.Entry[]?
---@field children table<string, kago.explorer.Entry[]>
...
---@field on_change fun(search: kago.explorer.Filter)
local Filter = {}
Filter.__index = Filter

---@param on_change fun(search: kago.explorer.Filter)
---@return kago.explorer.Filter
...
function Filter:open_input(parent, actions)
  ...
  vim.bo[buf].filetype = 'kago-explorer-filter'
