...
---@class kago.notify.Entry
---@field id integer|string
---@field win integer?
---@field buf integer?
---@field timer uv.uv_timer_t?

---@class kago.notify.HistoryEntry
---@field msg string
---@field level integer
---@field title string
---@field time integer

---@type kago.notify.Entry[]
local active = {}
---@type kago.notify.HistoryEntry[]
local history = {}

---@class kago.notify.Config
---@field display_ms integer
---@field max_history integer
---@field max_width_ratio number
---@field min_width integer

---@type kago.notify.Config
M.config = {
  display_ms = 3000,
  max_history = 50,
  max_width_ratio = 0.4,
...
---@param opts kago.notify.Config?
function M.setup(opts)
  M.config = vim.tbl_deep_extend('force', M.config, opts or {})

  setup_highlights()

  local group = vim.api.nvim_create_augroup('kago_notify', { clear = true })
