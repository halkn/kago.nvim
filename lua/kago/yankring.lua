...
---@class kago.yankring.Config
---@field highlight_ms integer
---@field max_size integer

---@class kago.yankring.Mappings
...
---@class kago.yankring.Setup
---@field highlight_ms integer?
---@field max_size integer?
---@field mappings kago.yankring.Mappings?

---@type kago.yankring.Config
M.config = {
  highlight_ms = 200,
  max_size = 30,
}
...
local ns = vim.api.nvim_create_namespace('kago_yankring_highlight')
---@type uv.uv_timer_t?
local hl_timer = nil
...
---@param opts kago.yankring.Setup?
function M.setup(opts)
  ...
  vim.api.nvim_create_autocmd('TextYankPost', {
    group = vim.api.nvim_create_augroup('kago_yankring', { clear = true }),
    callback = function()
