...
---@class kago.replace.Mappings
---@field replace string?

---@class kago.replace.Setup
---@field mappings kago.replace.Mappings?
...
---@param opts kago.replace.Setup?
function M.setup(opts)
  _G._kago_replace_op = M.op
  ...
  if mappings.replace and mappings.replace ~= '' then
    vim.keymap.set('n', mappings.replace, function()
      vim.o.operatorfunc = 'v:lua._kago_replace_op'
      return 'g@'
